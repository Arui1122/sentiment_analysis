...
df.to_excel('sentiments_regular2.xlsx')    #另存excel檔案
...
# print(df.head(5))
df.to_excel('sentiments_regular2.xlsx')
...
vect = CountVectorizer(max_df = 0.85,  #去除掉超過這一比例的文檔中出現的關鍵詞（過於平凡)
...
test.to_excel('TF_regular2.xlsx')
